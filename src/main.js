...
import defaultAvatar from './assets/ic_user.png';
...
Vue.prototype.$uploadUrl = 'http://14.23.70.230:6001/admin/file/upload';           // 上传请求路径
Vue.prototype.$downloadUrl = 'http://14.23.70.230:6001/admin/file/download/';      // 下载请求路径
